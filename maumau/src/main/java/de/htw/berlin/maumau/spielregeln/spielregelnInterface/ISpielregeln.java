...
public interface ISpielregeln {
    ...
    /**
     * Anhand des {@link Kartentyp} Wunschtyps wird geprueft, ob die neue {@link Karte} gelegt werden kann.
     *
    ...
    /**
     * Anhand der Farbe und des Werts der letzten {@link Karte} wird geprueft, ob die neue {@link Karte} gelegt werden kann.
     *
    ...
    /**
     * Es wird ueberprueft, ob die neue Karte {@link Karte} eine Sieben ist, wenn die letzte Karte auch eine Sieben ist.
     *
     * @param letzteKarte - die letzte Karte
    ...
    /**
     * Es wird ueberprueft, ob die neue Karte {@link Karte} ein Bube ist, wenn die letzte Karte auch ein Bube ist.
     *
     * @param letzteKarte - die letzte Karte
     * @param neueKarte   - die neue Karte die gelegt werden soll
